...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Order_Status: Schema.Attribute.Enumeration<['Confirm ', 'Not Confirm']> &
      Schema.Attribute.DefaultTo<'Not Confirm'>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sale_price: Schema.Attribute.BigInteger;
    ...
    thumbnail: Schema.Attribute.Media<'files' | 'images'> &
      Schema.Attribute.Required;
    gallary: Schema.Attribute.Media<'images', true> & Schema.Attribute.Required;
...
export interface ApiProductReviewProductReview
  ...
  attributes: {
    ...
    Review_Status: Schema.Attribute.Enumeration<['Draft', 'Published']> &
